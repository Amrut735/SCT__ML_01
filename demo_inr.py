#!/usr/bin/env python3
"""
Comprehensive Demonstration of the Optimized House Price Predictor (INR)
Shows all key features and capabilities with Indian Rupees and user input.
"""
...
def demonstrate_data_loading():
    """Demonstrate efficient data loading and preprocessing with INR conversion."""
    print("=" * 60)
    print("1. DATA LOADING & PREPROCESSING DEMONSTRATION (INR)")
    print("=" * 60)
    ...
    # Demonstrate preprocessing with INR conversion
    ...
    print(f"🇮🇳 All prices converted to Indian Rupees (INR)")

def demonstrate_model_training():
    """Demonstrate fast model training with INR coefficients."""
    print("\n" + "=" * 60)
    print("2. MODEL TRAINING DEMONSTRATION (INR)")
    print("=" * 60)
    ...
    # Show model coefficients in INR
    coefficients = dict(zip(predictor.feature_names, predictor.model.coef_))
    print(f"📈 Model coefficients (INR):")
    for feature, coef in coefficients.items():
        print(f"   {feature}: ₹{coef:,.2f}")
    print(f"   Intercept: ₹{predictor.model.intercept_:,.2f}")

def demonstrate_user_input_predictions():
    """Demonstrate house price predictions with user input."""
    print("\n" + "=" * 60)
    print("3. USER INPUT PREDICTION DEMONSTRATION")
    print("=" * 60)
    ...
    print("🏠 House Price Predictions (INR):")
...
def demonstrate_performance():
    """Demonstrate performance metrics in INR."""
    print("=" * 60)
    print("4. PERFORMANCE METRICS DEMONSTRATION (INR)")
    print("=" * 60)
    ...
    print(f"   ✅ INR conversion: USD to INR (1:83 ratio)")
...
def demonstrate_optimization_features():
    ...
    print("\n   5. INR Conversion:")
    print("      - USD to INR conversion (1:83 ratio)")
    print("      - Indian context pricing")
    print("      - Lakhs and crores display")
...
def demonstrate_scalability():
    ...
    print("   - INR conversion adds minimal overhead")

def interactive_prediction_demo():
    """Interactive prediction demonstration with user input."""
    print("\n" + "=" * 60)
    print("7. INTERACTIVE PREDICTION DEMONSTRATION")
    print("=" * 60)
    ...
    print("Enter house details to get price prediction in INR:")
    
    try:
        # Get user input
        square_footage = float(input("\n📏 Enter square footage: "))
        bedrooms = float(input("🛏️  Enter number of bedrooms: "))
...
def main():
    """Run comprehensive demonstration with INR and user input."""
    print("🏠 OPTIMIZED HOUSE PRICE PREDICTOR - COMPREHENSIVE DEMO (INR)")
    print("=" * 80)
    
    try:
        demonstrate_data_loading()
        demonstrate_model_training()
        demonstrate_user_input_predictions()
        ...
        print("✅ INR conversion working")
        print("✅ User input functionality working")
